...
function GetAllStates(model) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let states;
            if (model.id) {
                states = yield DbConnection_1.AppDataSource.getRepository(entities.States)
            ...
            const statesData = states.map((states) => ({
                id: states.Id,
                name: states.Name,
...
function CreateState(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const repository = DbConnection_1.AppDataSource.getRepository(entities.States);
            ...
            const savedRole = yield repository.save(states);
            return {
                status: 200,
...
function UpdateState(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
...
function DeleteState(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
