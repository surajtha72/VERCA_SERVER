            ...
            for (const record of model) {
                ...
                if (milkCollectionDetails) {
                    ...
                    milkCollectionDetails.TestingOperationType =
                        (_c = record.testingOperationType) !== null && _c !== void 0 ? _c : milkCollectionDetails.TestingOperationType;
                    milkCollectionDetails.Fat = (_d = record.fat) !== null && _d !== void 0 ? _d : milkCollectionDetails.Fat;
                    milkCollectionDetails.Snf = (_f = parseFloat((_e = record === null || record === void 0 ? void 0 : record.snf) === null || _e === void 0 ? void 0 : _e.toFixed(1))) !== null && _f !== void 0 ? _f : milkCollectionDetails.Snf;
                    //milkCollectionDetails.Snf = Math.trunc((Math.round(record?.snf * 100) / 100) * 10) / 10 ?? milkCollectionDetails.Snf;
                    milkCollectionDetails.Clr = (_g = record.clr) !== null && _g !== void 0 ? _g : milkCollectionDetails.Clr;
                    milkCollectionDetails.Protein = (_h = record.protein) !== null && _h !== void 0 ? _h : milkCollectionDetails.Protein;
                    milkCollectionDetails.Lactose = (_j = record.lactose) !== null && _j !== void 0 ? _j : milkCollectionDetails.Lactose;
                    milkCollectionDetails.Salt = (_k = record.salt) !== null && _k !== void 0 ? _k : milkCollectionDetails.Salt;
                    milkCollectionDetails.Water = (_l = record.water) !== null && _l !== void 0 ? _l : milkCollectionDetails.Water;
                    milkCollectionDetails.Temperature = (_m = record.temperature) !== null && _m !== void 0 ? _m : milkCollectionDetails.Temperature;
                    milkCollectionDetails.SampleNumber = (_o = record.sampleNumber) !== null && _o !== void 0 ? _o : milkCollectionDetails.SampleNumber;
                    milkCollectionDetails.Weight =
                        (_p = record.weight) !== null && _p !== void 0 ? _p : milkCollectionDetails.Weight;
                    milkCollectionDetails.CanCount =
                        (_q = record.canCount) !== null && _q !== void 0 ? _q : milkCollectionDetails.CanCount;
                    if (created) {
                        milkCollectionDetails.CreatedBy = created;
                    }
                    if (updated) {
                    ...
                    milkCollectionDetails.CollectedAt =
                        (_r = record.collectedAt) !== null && _r !== void 0 ? _r : milkCollectionDetails.CollectedAt;
                    milkCollectionDetails.TestedAt =
                        (_s = record.testedAt) !== null && _s !== void 0 ? _s : milkCollectionDetails.TestedAt;
                    milkCollectionDetails.CreatedAt =
                        (_t = record.createdAt) !== null && _t !== void 0 ? _t : milkCollectionDetails.CreatedAt;
                    milkCollectionDetails.ModifiedAt =
                        (_u = record.updatedAt) !== null && _u !== void 0 ? _u : milkCollectionDetails.ModifiedAt;
                    milkCollectionDetails.DeletedAt =
                        (_v = record.deletedAt) !== null && _v !== void 0 ? _v : milkCollectionDetails.DeletedAt;
