...
exports.CreateTransporters = exports.UpdateTransporters = exports.DeleteTransporters = exports.GetTransporters = void 0;
...
function GetTransporters(model) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let transporters;
            if (model.id) {
                transporters = yield DbConnection_1.AppDataSource.getRepository(entities.Transporters)
            ...
            const transportersData = transporters.map((transporters) => {
                var _a;
                return ({
                    id: transporters.Id,
                    ...
                    bankId: (_a = transporters.BankId) === null || _a === void 0 ? void 0 : _a.Id,
...
function CreateTransporters(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const bankId = yield DbConnection_1.AppDataSource.getRepository(entities.Bank)
                .createQueryBuilder("bank")
                .where("bank.Id = :id", { id: model.bankId })
                .getOne();
            const repository = DbConnection_1.AppDataSource.getRepository(entities.Transporters);
            ...
            yield repository.save(transporters);
            return {
                status: 200,
...
function UpdateTransporters(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            const transporters = yield repository.findOne({
...
function DeleteTransporters(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
