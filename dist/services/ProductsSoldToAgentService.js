...
exports.CreateProductsSoldToAgent = exports.GetProductSoldToAgent = void 0;
...
function GetProductSoldToAgent(model) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let productsSoldToAgent;
            productsSoldToAgent = yield DbConnection_1.AppDataSource.getRepository(entities.ProductsSoldToAgent)
                ...
                .getMany();
            const soldProductsData = productsSoldToAgent.map((soldProduct) => ({
                id: soldProduct.Id,
...
exports.GetProductSoldToAgent = GetProductSoldToAgent;
function CreateProductsSoldToAgent(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const productSalesToAgent = yield DbConnection_1.AppDataSource.getRepository(entities.ProductSalesToAgent)
...
exports.CreateProductsSoldToAgent = CreateProductsSoldToAgent;
