...
exports.LockCycle = exports.KrishiBazarReport = exports.AgentLedger = exports.GetPayoutCheckList = exports.BMCWisePayment = exports.RouteWiseBmcMilkCollection = exports.DateWiseBmcMilkCollection = exports.GetBmcWiseMilkCollection = exports.DateWiseAgentColletionDetail = exports.GetAgentWiseMilkCollection = exports.GetBmcSnfReconcillation = exports.GetBankLetterAmount = exports.GetBankAdvice = exports.GetRateChart = exports.GetBillByBMCRoutes = exports.GetBillByBMC = exports.GetBill = exports.DeleteCycleMaster = exports.UpdateCycleMaster = exports.CreateCycleMaster = exports.GetCycleMaster = void 0;
...
function GetCycleMaster(model) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let cycleMaster;
            if (model.id) {
                cycleMaster = yield DbConnection_1.AppDataSource.getRepository(entities.BillingCycleMaster)
            ...
            const cycleMasterData = cycleMaster.map((cycleMaster) => {
                var _a;
                return ({
                    id: cycleMaster === null || cycleMaster === void 0 ? void 0 : cycleMaster.Id,
                    financialYearId: cycleMaster.FinancialYearId
                        ? (_a = cycleMaster.FinancialYearId) === null || _a === void 0 ? void 0 : _a.Id
                        : 0,
                    cycleNo: cycleMaster === null || cycleMaster === void 0 ? void 0 : cycleMaster.CycleNo,
                    startDate: cycleMaster === null || cycleMaster === void 0 ? void 0 : cycleMaster.StartDate,
                    endDate: cycleMaster === null || cycleMaster === void 0 ? void 0 : cycleMaster.EndDate,
                    isFrozen: cycleMaster === null || cycleMaster === void 0 ? void 0 : cycleMaster.IsFrozen,
                });
            });
            return {
                status: 200,
...
exports.GetCycleMaster = GetCycleMaster;
function GetBill(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (let iteration = 0; iteration < orgArr.length; iteration++) {
                const route = [];
                for (let routeIteration = 0; routeIteration < milkCollectionDetails.length; routeIteration++) {
                    if (orgArr[iteration] ===
                        ...
                        const item = {
                            ...
                            commision: milkCollectionDetails[routeIteration].OrganizationUnitId
                                .Commission,
            ...
            for (let orgIteration = 0; orgIteration < org.length; orgIteration++) {
                for (let routeIteration = 0; routeIteration < org[orgIteration].route.length; routeIteration++) {
                    milkCollectionDetails.forEach((milkDetail) => {
                        const item = {
                            id: milkDetail.OrganizationUnitId.Id,
                            routeId: milkDetail.RouteId.Id,
                        };
                        if (org[orgIteration].route[routeIteration].id === item.id &&
                            org[orgIteration].route[routeIteration].routeId === item.routeId) {
                            org[orgIteration].route[routeIteration].collectionDetails.push(milkDetail);
                        }
                    });
                }
            }
            ...
            for (let orgIteration = 0; orgIteration < org.length; orgIteration++) {
                for (let routeIteration = 0; routeIteration < org[orgIteration].route.length; routeIteration++) {
                    ...
                    item = {
                        ...
                        settlementAmount: 0,
                        collectionDetails: groupItem["collectionDetails"].map((detail) => ({
                            Id: detail.Id,
                            ...
                            value: Number((((detail.Fat * 384 + detail.Snf * 256) / 100) *
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (let fat = 3.0; fat <= 10.0; fat += 0.1) {
                let rateStr = "";
                for (let snf = 7.5; snf <= 9.0; snf += 0.1) {
                    let rate = (0, MilkValueCalculator_1.calculateValue)(parseFloat(fat.toFixed(1)), parseFloat(snf.toFixed(1)), rateMaster);
                    rateStr += "  ";
...
function GetBillByBMC(req, model) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            const milkCollectionDetails = yield DbConnection_1.AppDataSource.getRepository(entities.MilkCollectionDetails)
                ...
                .getMany();
            const complaints = yield DbConnection_1.AppDataSource.getRepository(entities.Complaints)
            ...
            const resultArr = (0, AggregateCollectionData_1.aggregateData)(milkCollectionDetails);
            const rateMaster = yield DbConnection_1.AppDataSource.getRepository(entities.RateMaster)
                .createQueryBuilder("ratemaster")
                .where("ratemaster.Wef < :currDate", { currDate: new Date() })
                .andWhere("ratemaster.IsActive =:isActive", { isActive: true })
            ...
            for (let iteration = 0; iteration < orgArr.length; iteration++) {
                ...
                if (isFrozen) {
                    ...
                    const headloadHistory = yield DbConnection_1.AppDataSource.getRepository(entities.HeadloadHistory)
                        .createQueryBuilder("history")
                        .where("history.Agent_id = :organizationId", { organizationId })
                        .andWhere("history.BillingCycle = :cycleId", { cycleId: cycle.Id })
                        .getOne();
                    headload = (headloadHistory === null || headloadHistory === void 0 ? void 0 : headloadHistory.HeadLoad) || 0;
                }
                else {
                    ...
                    const organization = yield DbConnection_1.AppDataSource.getRepository(entities.Organization)
                        ...
                        .leftJoin("RouteStops", "routeStops", "routeStops.StopId = organization.Id")
                        .leftJoin("routeStops.RouteId", "routeMaster")
                        .where("organization.Id = :organizationId", { organizationId })
                        .getRawOne();
                    headload = (organization === null || organization === void 0 ? void 0 : organization.HeadLoad) || 0;
                }
                ...
                for (let routeIteration = 0; routeIteration < milkCollectionDetails.length; routeIteration++) {
                    if (orgArr[iteration] ===
                        milkCollectionDetails[routeIteration].OrganizationUnitId.Id) {
                        const item = {
                            id: (_b = milkCollectionDetails[routeIteration]) === null || _b === void 0 ? void 0 : _b.OrganizationUnitId.Id,
                            name: (_c = milkCollectionDetails[routeIteration]) === null || _c === void 0 ? void 0 : _c.OrganizationUnitId.Name,
                            // headload: milkCollectionDetails[routeIteration]?.OrganizationUnitId.HeadLoad,
                            headload: headload,
                            commision: (_d = milkCollectionDetails[routeIteration]) === null || _d === void 0 ? void 0 : _d.OrganizationUnitId.Commission,
                            routeId: milkCollectionDetails[routeIteration].RouteId.Id,
                            // routeId: routeId,
                            routeName: milkCollectionDetails[routeIteration].RouteId.RouteName,
                            // routeName: routeName,
            ...
            for (let orgIteration = 0; orgIteration < org.length; orgIteration++) {
                for (let routeIteration = 0; routeIteration < org[orgIteration].route.length; routeIteration++) {
                    resultArr.forEach((milkDetail) => {
                        ...
                        if (((_a = org[orgIteration].route[routeIteration]) === null || _a === void 0 ? void 0 : _a.id) === item.id &&
                            ((_b = org[orgIteration].route[routeIteration]) === null || _b === void 0 ? void 0 : _b.routeId) === item.routeId) {
                            (_c = org[orgIteration].route[routeIteration]) === null || _c === void 0 ? void 0 : _c.collectionDetails.push(milkDetail);
                        }
                    });
                }
            }
            ...
            for (let orgIteration = 0; orgIteration < org.length; orgIteration++) {
                for (let routeIteration = 0; routeIteration < org[orgIteration].route.length; routeIteration++) {
                    ...
                    const collectionDetails = groupItem["collectionDetails"].map((detail) => ({
                        Id: detail.Id,
                        MilkType: detail.MilkType,
                        CollectionOperationType: detail.CollectionOperationType,
                        TestingOperationType: detail.TestingOperationType,
                        Fat: detail.Fat,
                        KGFat: (parseFloat(detail.Weight.toFixed(3)) / 100) * parseFloat(detail.Fat.toFixed(3)),
                        Snf: detail.Snf,
                        KGSnf: (parseFloat(detail.Weight.toFixed(3)) / 100) * parseFloat(detail.Snf.toFixed(3)),
                        Clr: detail.Clr,
                        Weight: detail.Weight,
                        CanCount: detail.CanCount,
                        CollectedAt: detail.CollectedAt,
                        ...
                        organizationName: detail.OrganizationUnitId.Name,
                        shift: detail.MilkCollectionId.Shift,
                        value: Number((0, MilkValueCalculator_1.calculateValue)(parseFloat(detail.Fat.toFixed(1)), parseFloat((new Date(startDate) >= new Date("2024-07-21") &&
                            detail.Snf > 9.0
                            ? 9.0
                            : detail.Snf).toFixed(1)), rateMaster) * parseFloat(detail.Weight.toFixed(1))),
                    }));
                    ...
                    data.push({
                        ...
                        settlementAmount: settlementAmount !== null && settlementAmount !== void 0 ? settlementAmount : 0,
            ...
            for (const complaint of complaints) {
                ...
                data.push({
                    organization: {
                        ...
                        headload: 0,
                        commision: 0,
                        routeId: (organization === null || organization === void 0 ? void 0 : organization.RouteId) || 0,
                        routeName: (organization === null || organization === void 0 ? void 0 : organization.RouteName) || "",
                    },
                    settlementAmount: complaint.SettlementAmount,
                    collectionDetails: [],
                });
...
function GetAgentWiseMilkCollection(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            if (shift === undefined || shift === "both") {
                milkCollections = yield DbConnection_1.AppDataSource.getRepository(entities.MilkCollections)
                    .createQueryBuilder("milkCollections")
                    .where("DATE(milkCollections.CollectionDateTime) >= :startDate", {
                    startDate,
                })
            ...
            const bmc = yield DbConnection_1.AppDataSource.getRepository(entities.Organization)
                .createQueryBuilder("organization")
            ...
            for (let parentIter = 0; parentIter < parentOuArr.length; parentIter++) {
                ...
                let agentDetail = [];
                for (let iter = 0; iter < milkCollectionDetails.length; iter++) {
                    if (parentOuArr[parentIter] ==
                        ((_b = milkCollectionDetails[iter].OrganizationUnitId.ParentId) === null || _b === void 0 ? void 0 : _b.Id)) {
                        if (!agentArr.includes(milkCollectionDetails[iter].OrganizationUnitId.Id)) {
                ...
                for (let i = 0; i < agentArr.length; i++) {
                    ...
                    let buffCounter = 0;
                    for (let iter = 0; iter < milkCollectionDetails.length; iter++) {
                        if (agentArr[i] == milkCollectionDetails[iter].OrganizationUnitId.Id) {
...
function GetBmcSnfReconcillation(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            for (let parentIter = 0; parentIter < parentOuArr.length; parentIter++) {
                ...
                for (let iter = 0; iter < milkCollectionDetails.length; iter++) {
                    if (parentOuArr[parentIter] ==
                        ((_b = milkCollectionDetails[iter].OrganizationUnitId.ParentId) === null || _b === void 0 ? void 0 : _b.Id)) {
                        if (!collectedAtArr.includes((0, moment_1.default)(milkCollectionDetails[iter].MilkCollectionId.CollectionDateTime).format("YYYY-MM-DD"))) {
                            collectedAtArr.push((0, moment_1.default)(milkCollectionDetails[iter].MilkCollectionId.CollectionDateTime).format("YYYY-MM-DD"));
                        }
                    }
                }
                for (let i = 0; i < collectedAtArr.length; i++) {
                    ...
                    for (let iter = 0; iter < milkCollectionDetails.length; iter++) {
                        if (collectedAtArr[i] ==
                            (0, moment_1.default)(milkCollectionDetails[iter].MilkCollectionId.CollectionDateTime).format("YYYY-MM-DD")) {
                    ...
                    milkDetailArr.push({
                        ...
                        morningShift: {
                            cowMilkDetails: morningShift.cowMilkDetail.totalWeight != 0
                                ? morningShift.cowMilkDetail
                                : {},
                            buffMilkDetails: morningShift.buffMilkDetail.totalWeight !== 0
                                ? morningShift.buffMilkDetail
                                : {},
                        },
                        eveningShift: {
                            cowMilkDetails: eveningShift.cowMilkDetail.totalWeight != 0
                                ? eveningShift.cowMilkDetail
                                : {},
                            buffMilkDetails: eveningShift.buffMilkDetail.totalWeight !== 0
...
function GetBillByBMCRoutes(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // console.log(model)
            ...
            const routeDetail = yield DbConnection_1.AppDataSource.getRepository(entities.RouteMaster)
            ...
            const complaints = yield DbConnection_1.AppDataSource.getRepository(entities.Complaints)
                ...
                .getMany();
            const resultArray = (0, AggregateCollectionData_1.aggregateData)(milkCollectionDetails);
            const rateMaster = yield DbConnection_1.AppDataSource.getRepository(entities.RateMaster)
                .createQueryBuilder("ratemaster")
                .where("ratemaster.Wef < :currDate", { currDate: new Date() })
                .orderBy("ratemaster.SeqNo", "ASC")
            ...
            for (let iteration = 0; iteration < orgArr.length; iteration++) {
                ...
                if (isFrozen) {
                    ...
                    const headloadHistory = yield DbConnection_1.AppDataSource.getRepository(entities.HeadloadHistory)
                        ...
                        .getOne();
                    headload = (headloadHistory === null || headloadHistory === void 0 ? void 0 : headloadHistory.HeadLoad) || 0;
                    routeId = (headloadHistory === null || headloadHistory === void 0 ? void 0 : headloadHistory.RouteId) || 0;
                    routeName = (headloadHistory === null || headloadHistory === void 0 ? void 0 : headloadHistory.RouteName) || "";
                }
                else {
                    // console.log("data taken from org")
                    const organization = yield DbConnection_1.AppDataSource.getRepository(entities.Organization)
            ...
            for (let orgIteration = 0; orgIteration < org.length; orgIteration++) {
                for (let routeIteration = 0; routeIteration < org[orgIteration].route.length; routeIteration++) {
                    ...
                    const hasHighSnf = groupItem["collectionDetails"].some((detail) => detail.Snf > 9.0);
...
function GetBankLetterAmount(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // console.log(model)
            ...
            const collectionDetails = yield DbConnection_1.AppDataSource.getRepository(entities.MilkCollectionDetails)
                .createQueryBuilder("milkCollectionDetails")
                .leftJoinAndSelect("milkCollectionDetails.OrganizationUnitId", "organization")
                .leftJoinAndSelect("organization.ParentId", "organizationParent")
                .leftJoinAndSelect("organization.OrganizationType", "organizationType")
            ...
            const productsSoldToAgent = yield DbConnection_1.AppDataSource.getRepository(entities.ProductSalesToAgent)
            ...
            const complaints = yield DbConnection_1.AppDataSource.getRepository(entities.Complaints)
                ...
                .getMany();
            const milkCollectionDetails = (0, AggregateCollectionData_1.aggregateData)(collectionDetails);
            let totalAmount = 0;
            let deduction = 0;
            let earning = 0;
            let settlementAmount = 0;
                ...
                earning +=
                    parseInt(((((parseFloat(detail.Weight.toFixed(1)) / 100) *
                        ...
                        parseInt(((((parseFloat(detail.Weight.toFixed(1)) / 100) *
                            ...
                            // headload
                            .toFixed(1));
                totalAmount += Number((0, MilkValueCalculator_1.calculateValue)(parseFloat(detail.Fat.toFixed(1)), // Convert Fat to a number
                parseFloat((new Date(startDate) >= new Date("2024-07-21") && detail.Snf > 9.0
                    ? 9.0
                    : detail.Snf).toFixed(1)), // Ensure SNF is a number
                rateMaster) * parseFloat(detail.Weight.toFixed(1)) // Convert Weight to a number
                );
            }
...
function GetBankAdvice(req, model) {
        ...
        try {
            ...
            for (let iteration = 0; iteration < orgArr.length; iteration++) {
                ...
                if (isFrozen) {
                    ...
                    headload = (headloadHistory === null || headloadHistory === void 0 ? void 0 : headloadHistory.HeadLoad) || 0;
                    accNumber = (headloadHistory === null || headloadHistory === void 0 ? void 0 : headloadHistory.AccountNumber) || "";
                    accHolderName = (headloadHistory === null || headloadHistory === void 0 ? void 0 : headloadHistory.AccHolderName) || "";
                    ...
                    const organization = yield DbConnection_1.AppDataSource.getRepository(entities.Organization)
                        ...
                        .getRawOne();
                    headload = (organization === null || organization === void 0 ? void 0 : organization.HeadLoad) || 0;
                    accNumber = (organization === null || organization === void 0 ? void 0 : organization.AccountNumber) || "";
                    accHolderName = (organization === null || organization === void 0 ? void 0 : organization.AccHolderName) || "";
                ...
                for (let routeIteration = 0; routeIteration < milkCollectionDetails.length; routeIteration++) {
                    if (orgArr[iteration] ===
                        ...
                        const item = {
                            ...
                            headload: headload,
                            commision: (_d = milkCollectionDetails[routeIteration]) === null || _d === void 0 ? void 0 : _d.OrganizationUnitId.Commission,
                            routeId: (_e = milkCollectionDetails[routeIteration]) === null || _e === void 0 ? void 0 : _e.RouteId.Id,
                            // routeId: routeId,
                            // accountNumber: milkCollectionDetails[routeIteration]?.OrganizationUnitId.AccountNumber,
                            accountNumber: accNumber,
                            routeName: (_f = milkCollectionDetails[routeIteration]) === null || _f === void 0 ? void 0 : _f.RouteId.RouteName,
                            // routeName: routeName,
                            ifscCode: (_g = milkCollectionDetails[routeIteration]) === null || _g === void 0 ? void 0 : _g.OrganizationUnitId.IfscCode,
            ...
            for (let orgIteration = 0; orgIteration < org.length; orgIteration++) {
                ...
                if (productsSoldToAgent.length) {
                    for (let i = 0; i < productsSoldToAgent.length; i++) {
                        if (((_h = productsSoldToAgent[i].SoldToAgent) === null || _h === void 0 ? void 0 : _h.Id) == org[orgIteration].org) {
                            deduction += productsSoldToAgent[i].Balance;
                        }
                    }
                ...
                for (let routeIteration = 0; routeIteration < org[orgIteration].route.length; routeIteration++) {
                    ...
                    details.forEach((detail) => {
                        kgFat += (detail.Weight.toFixed(1) / 100) * detail.Fat.toFixed(1);
                        kgSnf += (detail.Weight.toFixed(1) / 100) * detail.Snf.toFixed(1);
                        totalAmount += Number((0, MilkValueCalculator_1.calculateValue)(detail.Fat.toFixed(1), (new Date(startDate) >= new Date("2024-07-21") && detail.Snf > 9.0
                            ? 9.0
                            : detail.Snf).toFixed(1), rateMaster) * detail.Weight.toFixed(1));
                    });
                    earning =
                        parseInt((((kgFat + kgSnf) / 12) *
                            100 *
                            ((_j = org[orgIteration].route[routeIteration]) === null || _j === void 0 ? void 0 : _j.headload)).toFixed(2)) +
                            parseInt((((kgFat + kgSnf) / 12) *
                                100 *
                                ((_k = org[orgIteration].route[routeIteration]) === null || _k === void 0 ? void 0 : _k.commision)).toFixed(2));
                    // console.log("total amount : ", totalAmount);
                    ...
                    const item = {
                        organization: {
                            ...
                            accHolderName: (_l = org[orgIteration].route[routeIteration]) === null || _l === void 0 ? void 0 : _l.accHolderName,
                            ifscCode: (_m = org[orgIteration].route[routeIteration]) === null || _m === void 0 ? void 0 : _m.ifscCode,
                            accNumber: (_o = org[orgIteration].route[routeIteration]) === null || _o === void 0 ? void 0 : _o.accountNumber,
...
//   }
// }`
function CreateCycleMaster(req, model) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            const decode = jwt.verify(token, key);
            const userId = decode.userId;
            const repository = DbConnection_1.AppDataSource.getRepository(entities.BillingCycleMaster);
            const financial = yield DbConnection_1.AppDataSource.getRepository(entities.FinancialYear)
            ...
            cycleMaster.CycleNo = (_b = model.cycleNo) !== null && _b !== void 0 ? _b : cycleMaster.CycleNo;
            cycleMaster.StartDate = (_c = model.startDate) !== null && _c !== void 0 ? _c : cycleMaster.StartDate;
            cycleMaster.EndDate = (_d = model.endDate) !== null && _d !== void 0 ? _d : cycleMaster.EndDate;
            cycleMaster.CreatedAt = new Date();
            cycleMaster.CreatedBy = userId;
            yield repository.save(cycleMaster);
            return {
                status: 200,
...
function UpdateCycleMaster(req, model) {
    var _a, _b, _c, _d, _e;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            const userId = decode.userId;
            const repository = DbConnection_1.AppDataSource.getRepository(entities.BillingCycleMaster);
            const cycleMaster = yield repository.findOne({
            ...
            if (cycleMaster) {
                ...
                cycleMaster.CycleNo = (_c = model.cycleNo) !== null && _c !== void 0 ? _c : cycleMaster.CycleNo;
                cycleMaster.StartDate = (_d = model.startDate) !== null && _d !== void 0 ? _d : cycleMaster.StartDate;
                cycleMaster.EndDate = (_e = model.endDate) !== null && _e !== void 0 ? _e : cycleMaster.EndDate;
...
function DeleteCycleMaster(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
...
function DateWiseAgentColletionDetail(req, model) {
    var _a, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            for (let iter = 0; iter < milkCollectionDetails.length; iter++) {
                if (!agentArr.includes(milkCollectionDetails[iter].OrganizationUnitId.Id)) {
                    ...
                    agentDetail.push({
                        agentId: milkCollectionDetails[iter].OrganizationUnitId.Id,
                        agentName: milkCollectionDetails[iter].OrganizationUnitId.Name,
                        parentId: (_b = milkCollectionDetails[iter].OrganizationUnitId.ParentId) === null || _b === void 0 ? void 0 : _b.Id,
                    });
                }
                if (!collectedAtArr.includes((0, moment_1.default)(milkCollectionDetails[iter].MilkCollectionId.CollectionDateTime).format("YYYY-MM-DD"))) {
                    collectedAtArr.push((0, moment_1.default)(milkCollectionDetails[iter].MilkCollectionId.CollectionDateTime).format("YYYY-MM-DD"));
            ...
            for (let parentIter = 0; parentIter < parent.length; parentIter++) {
                ...
                for (let agentIter = 0; agentIter < agentArr.length; agentIter++) {
                    ...
                    for (let i = 0; i < collectedAtArr.length; i++) {
                        ...
                        let eveningBuffMilkCounter = 0;
                        for (let iter = 0; iter < milkCollectionDetails.length; iter++) {
                            if (milkCollectionDetails[iter].OrganizationUnitId.Id ==
                                agentArr[agentIter] &&
                                (0, moment_1.default)(milkCollectionDetails[iter].MilkCollectionId.CollectionDateTime).format("YYYY-MM-DD") == collectedAtArr[i] &&
                                ((_c = milkCollectionDetails[iter].OrganizationUnitId.ParentId) === null || _c === void 0 ? void 0 : _c.Id) ==
                        ...
                        if (morningDetails.totalBuffMilkWeight !== 0 ||
                            eveningDetails.totalBuffMilkWeight !== 0 ||
                            morningDetails.totalCowMilkWeight !== 0 ||
                            eveningDetails.totalCowMilkWeight !== 0) {
                            milkDetailArr.push({
                                collectedAt: collectedAtArr[i],
                                morningMilkDetails: morningDetails.totalCowMilkWeight ||
                                    morningDetails.totalBuffMilkWeight
                                    ? morningDetails
                                    : {},
                            }, {
                                collectedAt: collectedAtArr[i],
                                eveningMilkDetails: eveningDetails.totalCowMilkWeight ||
                                    eveningDetails.totalBuffMilkWeight
                                    ? eveningDetails
                                    : {},
                            });
...
exports.DateWiseAgentColletionDetail = DateWiseAgentColletionDetail;
function GetBmcWiseMilkCollection(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            console.log(model);
            ...
            const endDate = model.endDate;
            const shift = model.shift;
            let milkCollections = yield DbConnection_1.AppDataSource.getRepository(entities.MilkCollections)
                .createQueryBuilder("milkCollections")
                .where("DATE(milkCollections.CollectionDateTime) >= :startDate", {
                startDate,
            })
            ...
            for (let parentIter = 0; parentIter < parentOuArr.length; parentIter++) {
                ...
                for (let iter = 0; iter < milkCollectionDetails.length; iter++) {
                    if (((_b = milkCollectionDetails[iter].OrganizationUnitId.ParentId) === null || _b === void 0 ? void 0 : _b.Id) ==
                        parentOuArr[parentIter]) {
                        if (milkCollectionDetails[iter].Fat < 5.4) {
                            cowMilkDetail.totalWeight += milkCollectionDetails[iter].Weight;
                            cowMilkDetail.avgFat += milkCollectionDetails[iter].Fat;
...
function DateWiseBmcMilkCollection(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
...
exports.DateWiseBmcMilkCollection = DateWiseBmcMilkCollection;
function RouteWiseBmcMilkCollection(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            if (shift === null) {
                ...
                const cycles = yield DbConnection_1.AppDataSource.getRepository(entities.BillingCycleMaster)
                    .createQueryBuilder("cycle")
            ...
            let routes = [];
            if (isFrozen) {
                routes = yield DbConnection_1.AppDataSource.getRepository(entities.RouteWiseCollectionHistory)
                ...
                routes = yield DbConnection_1.AppDataSource.getRepository(entities.RouteMaster)
            ...
            for (let routeIter = 0; routeIter < routes.length; routeIter++) {
                ...
                for (let i = 0; i < collectedAtArr.length; i++) {
                    ...
                    let buffMilkCounter = 0;
                    for (let iter = 0; iter < milkCollectionDetails.length; iter++) {
                        if (milkCollectionDetails[iter].RouteId.Id == routes[routeIter].Id &&
                            (0, moment_1.default)(milkCollectionDetails[iter].MilkCollectionId.CollectionDateTime).format("YYYY-MM-DD") == collectedAtArr[i]) {
                            if (milkCollectionDetails[iter].Fat < 5.4) {
                                cowMilkDetail.totalWeight += milkCollectionDetails[iter].Weight;
                                cowMilkDetail.avgFat += milkCollectionDetails[iter].Fat;
...
exports.RouteWiseBmcMilkCollection = RouteWiseBmcMilkCollection;
function BMCWisePayment(req, model) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            for (let bmcIter = 0; bmcIter < bmcs.length; bmcIter++) {
                ...
                if (productsSoldToAgent.length) {
                    for (let i = 0; i < productsSoldToAgent.length; i++) {
                        if (((_c = (_b = productsSoldToAgent[i].SoldToAgent) === null || _b === void 0 ? void 0 : _b.ParentId) === null || _c === void 0 ? void 0 : _c.Id) == bmcs[bmcIter].Id) {
                ...
                for (let iter = 0; iter < milkCollectionDetails.length; iter++) {
                    ...
                    if (((_d = milkCollectionDetails[iter].OrganizationUnitId.ParentId) === null || _d === void 0 ? void 0 : _d.Id) ==
                        bmcs[bmcIter].Id) {
                        if (milkCollectionDetails[iter].Fat < 5.4) {
                            ...
                            bmcPaymenetDetails.cowMilkDetail.amount +=
                                (0, MilkValueCalculator_1.calculateValue)(milkCollectionDetails[iter].Fat, milkCollectionDetails[iter].Snf, rateMaster) * milkCollectionDetails[iter].Weight;
                            cowMilkCounter++;
                        }
                        else {
                            ...
                            bmcPaymenetDetails.buffMilkDetail.amount +=
                                (0, MilkValueCalculator_1.calculateValue)(milkCollectionDetails[iter].Fat, new Date(startDate) >= new Date("2024-07-21") &&
                                    milkCollectionDetails[iter].Snf > 9.0
                                    ? 9.0
                                    : milkCollectionDetails[iter].Snf, rateMaster) * milkCollectionDetails[iter].Weight;
                            buffMilkCounter++;
                        }
                ...
                if (bmcPaymenetDetails.buffMilkDetail.quantity != 0 ||
...
exports.BMCWisePayment = BMCWisePayment;
function GetPayoutCheckList(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            const aggregatedData = {};
            collectionDetails.forEach((item) => {
                const key = `${(0, moment_1.default)(item.MilkCollectionId.CollectionDateTime).format("YYYY-MM-DD")}-${item.MilkType}-${item.OrganizationUnitId.Id}-${item.MilkCollectionId.Shift}`;
                if (!aggregatedData[key]) {
                    aggregatedData[key] = {
                        MilkType: item.MilkType,
                        Fat: item.Fat,
            ...
            for (let agentIter = 0; agentIter < orgArr.length; agentIter++) {
                ...
                if (productsSoldToAgent.length) {
                    for (let i = 0; i < productsSoldToAgent.length; i++) {
                        if (((_b = productsSoldToAgent[i].SoldToAgent) === null || _b === void 0 ? void 0 : _b.Id) == orgArr[agentIter]) {
                ...
                for (let milkIter = 0; milkIter < milkCollectionDetails.length; milkIter++) {
                    if (orgArr[agentIter] ==
                        milkCollectionDetails[milkIter].OrganizationUnitId.Id) {
                        details.totalQuantity += milkCollectionDetails[milkIter].Weight;
                        details.totalAmount += Number((0, MilkValueCalculator_1.calculateValue)(parseFloat(milkCollectionDetails[milkIter].Fat.toFixed(1)), 
                        // parseFloat(milkCollectionDetails[milkIter].Snf.toFixed(1)),
                        parseFloat((new Date(startDate) >= new Date("2024-07-21") &&
                            milkCollectionDetails[milkIter].Snf > 9.0
                            ? 9.0
                            : milkCollectionDetails[milkIter].Snf).toFixed(1)), rateMaster) * parseFloat(milkCollectionDetails[milkIter].Weight.toFixed(1)));
                ...
                details.earning =
                    parseInt((((kgFatSum + kgSnfSum) / 12) *
                        100 *
                        orgArrDetails[agentIter].Commission).toFixed(2)) +
                        parseInt((((kgFatSum + kgSnfSum) / 12) *
                            100 *
            ...
            // Handle unprocessed complaints
            for (const complaint of complaints) {
                const agentId = complaint.AgentId.Id;
                // Check if the agent is already processed
                if (!orgArr.includes(agentId)) {
                    let deduction = 0;
                    let routeName = "";
                    // Calculate deduction from productsSoldToAgent
                    productsSoldToAgent.forEach((sale) => {
                        var _a;
                        if (((_a = sale.SoldToAgent) === null || _a === void 0 ? void 0 : _a.Id) === agentId) {
                            deduction += sale.Balance;
                        }
                    });
                    // Fetch routeName from Organization or HeadloadHistory
                    if (isFrozen) {
                        // Fetch headload details from frozen cycles
                        const headloadHistory = yield DbConnection_1.AppDataSource.getRepository(entities.HeadloadHistory)
                            .createQueryBuilder("history")
                            .where("history.Agent_id = :organizationId", {
                        ...
                        // Fetch route details from Organization for non-frozen cycles
                        const organization = yield DbConnection_1.AppDataSource.getRepository(entities.Organization)
                            .createQueryBuilder("organization")
                            .select([
                            "organization.Id AS Id",
                    ...
                    // Prepare unprocessed complaint details
                    const unprocessedDetails = {
                        agentCode: agentId,
                        agentName: complaint.AgentId.Name,
                        totalQuantity: 0,
                        totalAmount: 0,
                        earning: 0,
                        deduction: deduction,
                    ...
                    // Push unprocessed complaint details to the final org array
                    org.push(unprocessedDetails);
                }
            }
            let finalDetails = [];
...
function AgentLedger(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            const agent = yield DbConnection_1.AppDataSource.getRepository(entities.Organization)
                .createQueryBuilder("organization")
                .innerJoinAndSelect("organization.OrganizationType", "organizationType")
            ...
            if (productsSoldToAgent.length) {
                for (let i = 0; i < productsSoldToAgent.length; i++) {
                    if (((_b = productsSoldToAgent[i].SoldToAgent) === null || _b === void 0 ? void 0 : _b.Id) == model.agentId) {
                        details.deduction += productsSoldToAgent[i].Balance;
                    }
                }
            }
            let headload = 0;
            for (let milkIter = 0; milkIter < milkCollectionDetails.length; milkIter++) {
                if (model.agentId == milkCollectionDetails[milkIter].OrganizationUnitId.Id) {
                    const organizationId = milkCollectionDetails[milkIter].OrganizationUnitId.Id;
                    if (isFrozen) {
                        // Fetch headload from HeadloadHistory table for frozen cycles
                        const headloadHistory = yield DbConnection_1.AppDataSource.getRepository(entities.HeadloadHistory)
                            .createQueryBuilder("history")
                    ...
                    details.milkValue += Number((0, MilkValueCalculator_1.calculateValue)(parseFloat(milkCollectionDetails[milkIter].Fat.toFixed(1)), parseFloat((new Date(startDate) >= new Date("2024-07-21") &&
                        milkCollectionDetails[milkIter].Snf > 9.0
                        ? 9.0
                        : milkCollectionDetails[milkIter].Snf).toFixed(1)), rateMaster) * parseFloat(milkCollectionDetails[milkIter].Weight.toFixed(1)));
                    // calculateValue(
...
function KrishiBazarReport(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            const endDate = model.endDate;
            const bmcId = model.bmcId;
            const salesDetail = yield DbConnection_1.AppDataSource.getRepository(entities.ProductsSoldToAgent)
                .createQueryBuilder("productsSoldToAgent")
                .leftJoinAndSelect("productsSoldToAgent.ProductSalesToAgent", "saleDetail")
                ...
                salesDetail.forEach((sale) => {
                    if (sale.ProductSalesToAgent.SoldToAgent.Id == agent) {
                        ...
                        const item = {
                            ...
                            paymentMode: sale.ProductSalesToAgent.Balance > 0 ? "Credit" : "Cash", // will need attention in the future.
                        };
                        details.push(item);
                    }
                });
...
function LockCycle(req, model) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            try {
                const organizationRepository = DbConnection_1.AppDataSource.getRepository(entities.Organization);
                const headloadHistoryRepository = DbConnection_1.AppDataSource.getRepository(entities.HeadloadHistory);
                const routeWiseCollectionHistoryRepository = DbConnection_1.AppDataSource.getRepository(entities.RouteWiseCollectionHistory);
                const organizationData = yield organizationRepository
                    .createQueryBuilder("organization")
                    .select([
                    "organization.Id AS Id",
                    "organization.HeadLoad AS HeadLoad",
                ...
                for (let i = 0; i < organizationData.length; i += batchSize) {
                    ...
                    yield headloadHistoryRepository.insert(batch);
                }
                // Fetch route data from RouteMaster and insert into RouteWiseCollectionHistory
                const routeData = yield DbConnection_1.AppDataSource.getRepository(entities.RouteMaster)
                    .createQueryBuilder("routeMaster")
                ...
                yield routeWiseCollectionHistoryRepository.insert(routeHistoryBatch);
            }
            catch (error) {
