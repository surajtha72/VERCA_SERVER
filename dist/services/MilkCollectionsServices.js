...
function calculateTotalWeight(milkCollectionId) {
    return __awaiter(this, void 0, void 0, function* () {
        const totalWeightResult = yield DbConnection_1.AppDataSource.getRepository(entities.MilkCollectionDetails)
...
function GetAllMilkCollections(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const totalWeightPromises = milkCollections.map((milkCollection) => __awaiter(this, void 0, void 0, function* () {
                const totalWeight = yield calculateTotalWeight(milkCollection === null || milkCollection === void 0 ? void 0 : milkCollection.Id);
                // console.log("total weight : ", totalWeight)
                return totalWeight;
            }));
            const totalWeights = yield Promise.all(totalWeightPromises);
            const milkCollectionsData = milkCollections.map((milkCollections, index) => ({
                id: milkCollections === null || milkCollections === void 0 ? void 0 : milkCollections.Id,
                shift: milkCollections === null || milkCollections === void 0 ? void 0 : milkCollections.Shift,
                status: milkCollections === null || milkCollections === void 0 ? void 0 : milkCollections.Status,
                collectionDateTime: milkCollections.CollectionDateTime,
                startedAt: milkCollections === null || milkCollections === void 0 ? void 0 : milkCollections.StartedAt,
                completedAt: milkCollections === null || milkCollections === void 0 ? void 0 : milkCollections.CompletedAt,
                ...
                milkDispatchId: (milkCollections === null || milkCollections === void 0 ? void 0 : milkCollections.MilkDispatchId)
                    ? milkCollections === null || milkCollections === void 0 ? void 0 : milkCollections.MilkDispatchId
                    : "",
...
function GetMilkCollectionsPortal(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
            ...
            const milkCollectionGtData = milkCollections.map((milkCollection) => __awaiter(this, void 0, void 0, function* () {
                const totalWeight = yield calculateGt(milkCollection === null || milkCollection === void 0 ? void 0 : milkCollection.Id);
                // console.log("total weight : ", totalWeight)
                return totalWeight;
            }));
...
//   }
// }
function CreateMilkCollection(req, model) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (const record of model) {
                const repository = DbConnection_1.AppDataSource.getRepository(entities.MilkCollections);
                let milkCollection = yield repository.findOneBy({ Id: record.id });
                if (!milkCollection) {
                    // If no record exists, create a new one
                    milkCollection = new entities.MilkCollections();
                    milkCollection.Id = (_b = record.id) !== null && _b !== void 0 ? _b : milkCollection.Id;
                    milkCollection.CreatedAt = (_c = record.createdAt) !== null && _c !== void 0 ? _c : new Date();
                }
                else {
                    // If record exists, update the modified timestamp
                    milkCollection.ModifiedAt = (_d = record.updatedAt) !== null && _d !== void 0 ? _d : new Date();
                }
                // Update milkDispatchId, dispatchQuantity, and remainingQuantity
                milkCollection.DispatchedQuantity = (_e = record.dispatchedQuantity) !== null && _e !== void 0 ? _e : milkCollection.DispatchedQuantity;
                milkCollection.RemainingQuantity = (_f = record.remainingQuantity) !== null && _f !== void 0 ? _f : milkCollection.RemainingQuantity;
                milkCollection.MilkDispatchId = (_g = record.milkDispatchId) !== null && _g !== void 0 ? _g : milkCollection.MilkDispatchId;
                // Common fields to update
                milkCollection.Shift = (_h = record.shift) !== null && _h !== void 0 ? _h : milkCollection.Shift;
                milkCollection.Status = (_j = record.status) !== null && _j !== void 0 ? _j : milkCollection.Status;
                milkCollection.StartedAt = (_k = record.startedAt) !== null && _k !== void 0 ? _k : milkCollection.StartedAt;
                milkCollection.CollectionDateTime = (_l = record.collectionDateTime) !== null && _l !== void 0 ? _l : milkCollection.CollectionDateTime;
                milkCollection.CompletedAt = (_m = record.completedAt) !== null && _m !== void 0 ? _m : milkCollection.CompletedAt;
                milkCollection.DeletedAt = (_o = record.deletedAt) !== null && _o !== void 0 ? _o : milkCollection.DeletedAt;
                milkCollection.Fat = record.fat ? record.fat : milkCollection.Fat;
                milkCollection.Clr = record.clr ? record.clr : milkCollection.Clr;
                //if (record.fat && record.clr) {
                //  milkCollection.Snf = parseFloat((record.clr / 4 + 0.20 * record.fat + 0.66).toFixed(1));
                ...
                const billingCycle = yield DbConnection_1.AppDataSource.getRepository(entities.BillingCycleMaster)
                    ...
                    .andWhere("billingCycle.EndDate >= :endDate", { endDate: record.collectionDateTime })
                    .getOne();
                const createdBy = yield DbConnection_1.AppDataSource.getRepository(entities.User)
                    .createQueryBuilder("user")
                    .where("user.Id = :id", { id: record.createdBy })
                    .getOne();
                const updatedBy = yield DbConnection_1.AppDataSource.getRepository(entities.User)
                    .createQueryBuilder("user")
                    .where("user.Id = :id", { id: record.updatedBy })
                    .getOne();
                const deletedBy = yield DbConnection_1.AppDataSource.getRepository(entities.User)
                    .createQueryBuilder("user")
                    .where("user.Id = :id", { id: record.deletedBy })
                    .getOne();
                ...
                yield repository.save(milkCollection);
...
function UpdateMilkCollection(req, model) {
    var _a, _b, _c, _d;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (const record of model) {
                const repository = DbConnection_1.AppDataSource.getRepository(entities.MilkCollections);
                const milkCollection = yield repository.findOne({
                ...
                if (milkCollection) {
                    ...
                    milkCollection.CollectionDateTime =
                        (_c = record.collectionDateTime) !== null && _c !== void 0 ? _c : milkCollection.CollectionDateTime;
                    ...
                    milkCollection.MilkDispatchId = (_d = record.milkDispatchId) !== null && _d !== void 0 ? _d : milkCollection.MilkDispatchId;
                    milkCollection.Fat = record.fat ? record.fat : milkCollection.Fat;
                    milkCollection.Clr = record.clr ? record.clr : milkCollection.Clr;
                    //if (record.fat && record.clr) {
                    //  milkCollection.Snf = parseFloat((record.clr / 4 + 0.20 * record.fat + 0.66).toFixed(1));
...
function LockMilkBill(req, model) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (milkCollections) {
                yield DbConnection_1.AppDataSource.getRepository(entities.MilkCollections)
                    .createQueryBuilder()
...
function SendSms(milkCollectionId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const collectionDetails = yield DbConnection_1.AppDataSource.getRepository(entities.MilkCollectionDetails)
            ...
            .getMany();
        const milkCollectionDetails = (0, AggregateCollectionData_1.smsAggregateData)(collectionDetails);
        let agentIds = [];
        ...
        agentIds.forEach((id) => {
            ...
            milkCollectionDetails.forEach((detail) => {
                if (detail.OrganizationUnitId.Id == id && detail.OrganizationUnitId.PhoneNumber !== null) {
                    ...
                    agentCollectionDetail.date = (0, moment_1.default)(detail.MilkCollectionId.CollectionDateTime).format("DD-MM-YYYY");
...
function DeleteMilkCollection(req, model) {
    var _a, _b;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = (_a = req.headers.authorization) === null || _a === void 0 ? void 0 : _a.split(" ")[1];
