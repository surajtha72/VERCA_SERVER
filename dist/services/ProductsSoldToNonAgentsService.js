...
exports.CreateProductsSoldToNonAgents = exports.GetProductSoldToNonAgents = void 0;
...
function GetProductSoldToNonAgents(model) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let productsSoldToNonAgents;
            productsSoldToNonAgents = yield DbConnection_1.AppDataSource.getRepository(entities.ProductsSoldToNonAgents)
                ...
                .getMany();
            const soldProductsData = productsSoldToNonAgents.map((soldProduct) => ({
                id: soldProduct.Id,
...
exports.GetProductSoldToNonAgents = GetProductSoldToNonAgents;
function CreateProductsSoldToNonAgents(req, model) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const ProductSalesToNonAgents = yield DbConnection_1.AppDataSource.getRepository(entities.ProductSalesToAgent)
...
exports.CreateProductsSoldToNonAgents = CreateProductsSoldToNonAgents;
