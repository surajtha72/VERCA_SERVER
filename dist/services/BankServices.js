...
function GetAllBanks(model) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            let banks;
            if (model.id) {
                banks = yield DbConnection_1.AppDataSource.getRepository(entities.Bank)
...
function CreateBank(req, model) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const repository = DbConnection_1.AppDataSource.getRepository(entities.Bank);
            ...
            const savedRole = yield repository.save(bank);
            return {
                status: 200,
...
function UpdateBank(req, model) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const userId = decode.userId;
            const repository = DbConnection_1.AppDataSource.getRepository(entities.Bank);
            const bank = yield repository.findOne({
