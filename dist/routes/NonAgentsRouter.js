...
exports.nonAgentsRouter = void 0;
const express = __importStar(require("express"));
const NonAgentsController = __importStar(require("../controllers/NonAgentsController"));
const Authorization_1 = require("../Authorization");
let nonAgentsRouter = express.Router();
exports.nonAgentsRouter = nonAgentsRouter;
/**
 * @swagger
 * tags:
 *   name: Non Agents
 ...
 *                   example: null
 */
nonAgentsRouter.get("/", Authorization_1.VerifyToken, NonAgentsController.GetAllNonAgents);
/**
 * @swagger
 * /api/v1/non-agents:
 *   post:
 ...
 *                   example: "Internal Server Error"
 */
nonAgentsRouter.post("/", Authorization_1.VerifyToken, NonAgentsController.CreateNonAgents);
/**
 * @swagger
 * /api/v1/non-agents:
 *   put:
 ...
 *                   example: "Internal Server Error"
 */
nonAgentsRouter.put("/", Authorization_1.VerifyToken, NonAgentsController.UpdateNonAgents);
/**
 * @swagger
 ...
 *                   example: "Internal Server Error"
 */
nonAgentsRouter.delete("/:id", Authorization_1.VerifyToken, NonAgentsController.DeleteNonAgents);
