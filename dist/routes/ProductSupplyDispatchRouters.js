...
// const productSupplyRouterDispatch = express.Router();
// /**
//  * @swagger
//  * tags:
//  *   name: Product Supply Dispatch
...
// /**
//  * @swagger
//  * /api/v1/product_supply_dispatch:
//  *   get:
//  *     tags: [Product Supply Dispatch]
...
//  *                   type: array
//  *                   items:
//  *                     $ref: '#/components/schemas/AllProductSupplyModelDispatch'
//  *       '500':
...
//  *                   example: null
//  */
// productSupplyRouterDispatch.get("/", VerifyToken, VerifyUser("Read", "Products"), ProductSupplyController.GetProductSupplyDispatch);
// /**
//  * @swagger
//  * /api/v1/product_supply_dispatch:
//  *   put:
...
//  *                   example: "Internal Server Error"
//  */
// productSupplyRouterDispatch.put("/", VerifyToken, VerifyUser("Update", "Products"), ProductSupplyController.UpdateProductSupplyDispatch);
// export { productSupplyRouterDispatch };
