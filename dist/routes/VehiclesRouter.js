 ...
 *                   example: null
 */
vehiclesRouter.get("/", Authorization_1.VerifyToken, (0, Authorization_1.VerifyUser)("Read", "Vehicles"), VehicleController.GetAllVehicles);
/**
 * @swagger
 * /api/v1/transporters/vehicles:
 *   post:
 ...
 *                   example: "Internal Server Error"
 */
vehiclesRouter.post("/", Authorization_1.VerifyToken, (0, Authorization_1.VerifyUser)("Create", "Vehicles"), VehicleController.CreateVehicle);
/**
 * @swagger
 * /api/v1/transporters/vehicles:
 *   put:
 ...
 *                   example: "Internal Server Error"
 */
vehiclesRouter.put("/", Authorization_1.VerifyToken, (0, Authorization_1.VerifyUser)("Update", "Vehicles"), VehicleController.UpdateVehicle);
/**
 * @swagger
 ...
 *                   example: "Internal Server Error"
 */
vehiclesRouter.delete("/:id", Authorization_1.VerifyToken, (0, Authorization_1.VerifyUser)("Delete", "Vehicles"), VehicleController.DeleteVehicle);
