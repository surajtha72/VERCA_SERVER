...
exports.MilkCollectionModelPortal = exports.DeleteMilkCollectionModel = exports.UpdateMilkCollectionModel = exports.CreateMilkCollectionModel = exports.AllMilkCollectionsModel = void 0;
class AllMilkCollectionsModel {
    constructor(data) {
...
exports.AllMilkCollectionsModel = AllMilkCollectionsModel;
class MilkCollectionModelPortal {
    constructor(data) {
...
exports.MilkCollectionModelPortal = MilkCollectionModelPortal;
class CreateMilkCollectionModel {
    constructor(data) {
        var _a, _b, _c;
        this.id = data.id;
        this.shift = data.shift;
...
exports.CreateMilkCollectionModel = CreateMilkCollectionModel;
class UpdateMilkCollectionModel {
    constructor(data) {
        var _a, _b, _c;
        this.id = data.id;
        this.shift = data.shift;
...
exports.UpdateMilkCollectionModel = UpdateMilkCollectionModel;
class DeleteMilkCollectionModel {
    constructor(data) {
        this.id = data.id;
    }
}
exports.DeleteMilkCollectionModel = DeleteMilkCollectionModel;
