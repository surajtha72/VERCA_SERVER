...
import * as FarmerMilkCollectionsController from "../controllers/FarmerMilkCollectionsController";
 ...
 *                   example: null
 */
farmerMilkCollectionsRouter.get("/", VerifyToken, VerifyUser("Read", "MilkCollection"), FarmerMilkCollectionsController.GetAllFarmerMilkCollections);

farmerMilkCollectionsRouter.get("/portal", VerifyToken, VerifyUser("Read", "MilkCollection"), FarmerMilkCollectionsController.GetFarmerMilkCollectionsPortal);

farmerMilkCollectionsRouter.get("/unlocked_billing_cycles", VerifyToken, VerifyUser("Read", "MilkCollection"), FarmerMilkCollectionsController.GetUnlockedBillingCycles);
 ...
 *                   example: null
 */
farmerMilkCollectionsRouter.get("/routes",VerifyToken,  FarmerMilkCollectionsController.GeFarmerMilkRoutes);
 ...
 *                   example: "Internal Server Error"
 */
farmerMilkCollectionsRouter.post("/",VerifyToken, FarmerMilkCollectionsController.CreateFarmerMilkCollection);
 ...
 *                   example: "Internal Server Error"
 */
farmerMilkCollectionsRouter.put("/",VerifyToken, FarmerMilkCollectionsController.UpdateFarmerMilkCollection);
farmerMilkCollectionsRouter.put("/lock_milk_bill",VerifyToken, FarmerMilkCollectionsController.LockMilkBill);
 ...
 *                   example: "Internal Server Error"
 */
farmerMilkCollectionsRouter.delete("/:id", VerifyToken, FarmerMilkCollectionsController.DeleteFarmerMilkCollection);

export { farmerMilkCollectionsRouter }