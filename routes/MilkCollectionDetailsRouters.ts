...
import * as MilkCollectionDetailsController from "../controllers/MilkCollectionDetailsController";
 ...
 *                   example: null
 */
milkCollectionDetailsRouter.get(
  "/",
  VerifyToken,
  VerifyUser("Read", "MilkCollection"),
  MilkCollectionDetailsController.GetAllMilkCollectionDetails
);
 ...
 *                   example: "Internal Server Error"
 */
milkCollectionDetailsRouter.post(
  "/",
  VerifyToken,
  VerifyUser("Create", "MilkCollection"),
  MilkCollectionDetailsController.CreateMilkCollectionDetails
);
 ...
 *                   example: "Internal Server Error"
 */
milkCollectionDetailsRouter.put(
  "/",
  VerifyToken,
  VerifyUser("Update", "MilkCollection"),
  MilkCollectionDetailsController.UpdateMilkCollectionDetails
);
 ...
 *                   example: "Internal Server Error"
 */
milkCollectionDetailsRouter.delete(
  "/:id",
  VerifyToken,
  VerifyUser("Delete", "MilkCollection"),
  MilkCollectionDetailsController.DeleteMilkCollectionDetails
);

export { milkCollectionDetailsRouter };
