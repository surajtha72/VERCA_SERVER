 ...
 *                   example: null
 */
userRouter.get("/", VerifyToken, VerifyUser("Read", "Users"), UserController.GetAllUsers);
 ...
 *                   example: "Internal Server Error"
 */
userRouter.post("/", VerifyToken, VerifyUser("Create", "Users"), UserController.CreateUser);
 ...
 *                   example: "Internal Server Error"
 */
userRouter.put("/", VerifyToken, VerifyUser("Update", "Users"), UserController.UpdateUser);
 ...
 *                   example: "Internal Server Error"
 */
userRouter.delete("/:id", VerifyToken, VerifyUser("Delete", "Users"), UserController.DeleteUser);
