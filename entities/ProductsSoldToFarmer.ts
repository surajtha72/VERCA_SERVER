...
import { ProductSalesToFarmer } from "./ProductSalesToFarmer";
import { ProductMaster } from "./ProductMaster";
import { User } from "./User";

@Entity()
export class ProductsSoldToFarmer{
    @PrimaryGeneratedColumn({name: "id"})
    Id: number;

    @ManyToOne(()=>ProductSalesToFarmer, { nullable: true })
    @JoinColumn({ name: "product_sales_to_Farmer"})
    ProductSalesToFarmer: ProductSalesToFarmer;
